 ...
 * TODO
 */
package com.darly.token.service;
...
import com.darly.token.ui.MainActivity;

/**
 * @author zhangyh2 a $ 下午2:12:42 TODO 应用程序升级，后台启动服务进行下载安装升级。
 */
					...
					if (is != null) {
						...
						while ((read = bis.read(buffer)) != -1 && !cancelUpdate) {
							...
							if (precent - download_precent >= 5) {
								Log.i("precent", download_precent+"");
